...
ti.targets.C28_float.rootDir ?= C:/ti/ccs1040/ccs/tools/compiler/ti-cgt-c2000_20.2.5.LTS
...
-include package/cfg/app_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
...
package/cfg/app_p28FP.xdc.inc: package/cfg/app_p28FP.xdl
package/cfg/app_p28FP.xdl package/cfg/app_p28FP.c: .interfaces
...
app.x28FP: package/cfg/app_p28FP.o28FP 
	...
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 -z  -o $@ package/cfg/app_p28FP.o28FP   package/cfg/app_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
app.x28FP: export C_DIR=
