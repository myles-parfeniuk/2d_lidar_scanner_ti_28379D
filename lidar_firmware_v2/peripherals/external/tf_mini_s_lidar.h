...
static const char lidar_cmd_distance[LIDAR_CMD_DIST_SZ]= {0x5A,0x05,0x00,0x01,0x60}; // get distance i2c command
static const char lidar_cmd_frame_rate[LIDAR_CMD_FRAME_RATE_SZ] = {0x5A, 0x06, 0x03, LIDAR_FRAME_RATE_LL, LIDAR_FRAME_RATE_HH, (char)LIDAR_FRAME_RATE_CHECKSUM}; // set frame rate i2c command
